...
export function ReferForm() {
  ...
  const handleSave = () => {
    console.log("Refer saved:", formData)
    // Save logic here
  }
  ...
  return (
    <div className="space-y-6">
      <Card className="card-rounded border-0 shadow-md max-w-5xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-[#2C4F4F]">Refer Ambulance</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="space-y-2">
              <Label htmlFor="ipdNo" className="text-sm font-medium text-gray-700">
                IPD No
              </Label>
              <Input
                id="ipdNo"
